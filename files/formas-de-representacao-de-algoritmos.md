...
A **descrição narrativa** expressa os algoritmos diretamente em **linguagem natural**, semelhante à forma utilizada em algoritmos não computacionais, como receitas culinárias.  

Nessa forma de representação, as instruções são descritas livremente, mas é importante seguir algumas regras básicas para manter a clareza:  

- Usar **somente um verbo por frase**;  
- Imaginar que o algoritmo será entendido por pessoas **que não trabalham com informática**;  
...
> **Sintaxe:** Regras que definem **como escrever corretamente** um comando.  
> **Exemplo:** Em muitas linguagens, esquecer o ponto e vírgula (`;`) é um erro de sintaxe.  
>
